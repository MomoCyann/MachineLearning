...
class PATTERNCOLLECT:
    ...
    def __init__(self):
        ...
        self.data = pd.read_csv(self.root + 'allevents_washed_final_label.csv', encoding='gbk')
    ...
    def label_transform(self):
        ...
        pattern_data.loc[(pattern_data['事件类型'] == 'accel') & (pattern_data['异常标签'] == 2), 'pattern_label'] = 'b'
        pattern_data.loc[(pattern_data['事件类型'] == 'accel') & (pattern_data['异常标签'] == 3), 'pattern_label'] = 'c'
        pattern_data.loc[(pattern_data['事件类型'] == 'brake') & (pattern_data['异常标签'] == 1), 'pattern_label'] = 'h'
        pattern_data.loc[(pattern_data['事件类型'] == 'brake') & (pattern_data['异常标签'] == 2), 'pattern_label'] = 'i'
        pattern_data.loc[(pattern_data['事件类型'] == 'brake') & (pattern_data['异常标签'] == 3), 'pattern_label'] = 'j'
        pattern_data.loc[(pattern_data['事件类型'] == 'turn') & (pattern_data['异常标签'] == 1), 'pattern_label'] = 'o'
        pattern_data.loc[(pattern_data['事件类型'] == 'turn') & (pattern_data['异常标签'] == 2), 'pattern_label'] = 'q'
        pattern_data.loc[(pattern_data['事件类型'] == 'turn') & (pattern_data['异常标签'] == 3), 'pattern_label'] = 'p'
