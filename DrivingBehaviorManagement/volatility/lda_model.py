...
class LDA:
    ...
    def lda_train(self):
        patterns_data = pd.read_csv(self.root + 'all_patterns.csv', encoding='gbk')
        ...
        print('probability complete')
        all_patterns_proba.to_csv(self.root + 'all_patterns_proba.csv',encoding='gbk')
