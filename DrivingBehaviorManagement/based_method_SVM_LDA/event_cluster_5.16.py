...
model_isof = IsolationForest(contamination=0.05, max_features=12,n_estimators=200)
...
# data_merge_turn.drop('Unnamed: 0', axis=1, inplace=True)
    data_merge.to_csv(root + 'allevents_washed_outlier.csv', encoding='gbk')
...
# # # data_outlier_row_accel = pd.read_csv(root + 'data_merge_accel_outlier.csv', encoding='gbk')
# # # data_outlier_row_brake = pd.read_csv(root + 'data_merge_brake_outlier.csv', encoding='gbk')
# # # data_outlier_row_turn = pd.read_csv(root + 'data_merge_turn_outlier.csv', encoding='gbk')
...
# data_outlier = get_attribute(data_outlier_row)
# #
# #
