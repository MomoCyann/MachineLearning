...
class Eventpred:
    ...
    def predict(self):
        ...
        for item in [self.accel_dataset, self.brake_dataset, self.turn_dataset]:
            y = item['风险等级']
            y = y.astype('int')
            X = item[['最大速度',
                      '最小速度',
...
if __name__ == '__main__':
    ...
    event_predictor = Eventpred(clf_accel_model, clf_brake_model, clf_turn_model)
    event_predictor.predict()
