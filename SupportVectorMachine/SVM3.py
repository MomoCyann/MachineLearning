...
if __name__ == "__main__":
    print('start loading')
    # 输入训练集
    train_data, train_label = LoadData('D:/GitHub/MachineLearning/SupportVectorMachine/mnist_train.csv')

    # 输入测试集
    test_data, test_label = LoadData('D:/GitHub/MachineLearning/SupportVectorMachine/mnist_test.csv')
    print('end loading')
